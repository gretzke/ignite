...
function libraryNames(data: ArtifactData | undefined): string[] {
  return Object.values(data?.creationCodeLinkReferences ?? {}).flatMap((source) => Object.keys(source));
}
